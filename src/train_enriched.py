...
motor que `src.train_longest_by_image`; solo cambia el dataset y el target.
"""
...
TRAIN_CONFIG = VlmLoraTrainConfig(
    ...
    comparison_protocol="matched_to_dataset_longest_answer_by_image",
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--epochs", type=int, default=1, help="Epochs de entrenamiento; default 1 para comparar con longest by-image.")
